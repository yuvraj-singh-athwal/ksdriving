      ...
      <div className="container mx-auto px-6 py-4">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 space-y-4">
            ...
            <a href="#why-us" className="block hover:text-yellow-300 transition">Why Choose Us</a>
            <a href="#pricing" className="block hover:text-yellow-300 transition">Pricing</a>
            <a href="#testimonials" className="block hover:text-yellow-300 transition">Testimonials</a>
            <a href="#contact" className="block hover:text-yellow-300 transition">Contact Us</a>
          </div>
        )}
      </div>
    </header>
